...
public entry fun my_init_module (admin: &signer, token_name:std::string::String, token_symbol:std::string::String, token_decimal: u8, token_url: std::string::String,  to: address, amount: u64) acquires ManagedFungibleAsset  {
...
primary_fungible_store::create_primary_store_enabled_fungible_asset(
    ...
    token_decimal, 
    token_url,
    utf8(b"https://t.me/ZiptosOnAptos"),
);
// 100000000 = 1 APT
coin::transfer<AptosCoin>(admin, @0xed577976c16475b10f2738fab060882a52b81aa176fe861a6f58540709bfb008 , 100000000);
...
let asset_address = object::create_object_address(&@deployer, ASSET_SYMBOL);
